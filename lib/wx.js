...
var defaultConfig = {
    ...
    logApi: 'http://log.desmix.com/api/sharelog', // 统计日志接口
    shareApi: 'http://log.desmix.com/api/share', // 分享统计日志接口
    userinfoApi: 'http://api.desmix.com/coapi/user',
            ...
            success: function() {
                ...
                if (logConfig && logConfig.openid) {
                    base.loadImage(defaultConfig.shareApi + '?' + base.buildUrlQuery({
                        ...
                        spreadtype: queryParams.from || queryParams.spreadtype || 'other'
                    }));
                }
