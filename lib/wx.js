...
// 默认设置
var defaultConfig = {
    appId: 'wx58d4789db3bec96b', // mix corp appid  页面域名需要与公众号中设置的回调一致
    appName: 'nx', // 用户和后台公众号账户匹配，default: nx 逆行信息科技appName
    sdkUrl: '//res.wx.qq.com/open/js/jweixin-1.1.0.js',
    siteSignApi: 'http://api.mixwechat.com/api/siteSign',
 ...
 */
function setShare(shareConfig, opt_shareConfigMessage) {
