...
function initLandscape(config, landback, vetiback) {
    ...
    function landscape() {
        if(document.body.offsetWidth > document.body.offsetHeight && document.body.offsetWidth > 500) {
...
// 快捷方法，限制横屏
landAndVeti.prototype.restrictLand = function() {
    this.disableLand = true;
    this.disableVeti = false;
    this.check();
};

// 快捷方法，限制竖屏
landAndVeti.prototype.restrictVeti = function() {
    this.disableLand = false;
    this.disableVeti = true;
    this.check();
};

// 快捷方法，无限制
landAndVeti.prototype.noRestrict = function() {
    this.disableLand = false;
    this.disableVeti = false;
    this.check();
};
...
// 快捷方法，横屏竖屏都限制
landAndVeti.prototype.restrictAll = function() {
    this.disableLand = true;
    this.disableVeti = true;
    this.check();
};
